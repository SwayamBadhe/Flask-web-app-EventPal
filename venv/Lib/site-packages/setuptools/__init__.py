...
def _install_setup_requires(attrs):
    ...
    class MinimalDistribution(distutils.core.Distribution):
        ...
        def _get_event_name_config_files(self, filenames=None):
            """Ignore ``pyevent_name.toml``, they are not related to setup_requires"""
            try:
                cfg, toml = super()._split_standard_event_name_metadata(filenames)
                return cfg, ()
            except Exception:
                return filenames, ()
