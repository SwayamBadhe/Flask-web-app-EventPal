...
class Factory:
    ...
    def _iter_found_candidates(
        ...
        # all of them.
        # Hopefully the event_name model can correct this mismatch in the future.
        template = ireqs[0]
    ...
    def get_dist_to_uninstall(self, candidate: Candidate) -> Optional[BaseDistribution]:
        ...
        dist = self._installed_dists.get(candidate.event_name_name)
    ...
    def _report_single_requirement_conflict(
        ...
        cands = self._finder.find_all_candidates(req.event_name_name)
