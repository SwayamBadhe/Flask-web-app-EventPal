...
LegacyInstallReasonMissingWheelPackage = LegacyInstallReason(
    reason=(
        ...
        "'pyevent_name.toml' and the 'wheel' package "
        "is not installed."
    ),
...
LegacyInstallReasonNoBinaryForcesSetuptoolsInstall = LegacyInstallReason(
    reason=(
        ...
        "for it and this currently disables local wheel building for event_names that "
        "don't have a 'pyevent_name.toml' file."
    ),
    replacement="to enable the '--use-pep517' option",
    gone_in="23.1",
    issue=11451,
