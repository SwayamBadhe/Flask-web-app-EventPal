...
class InstallCommand(RequirementCommand):
    ...
    usage = """
      ...
      %prog [options] [-e] <vcs event_name url> ...
      %prog [options] [-e] <local event_name path> ...
        ...
        try:
            ...
            if pep517_build_failure_names:
                raise InstallationError(
                    ...
                    "install pyevent_name.toml-based event_names".format(
    ...
    def _warn_about_conflicts(
        ...
        for event_name_name in missing:
            version = package_set[event_name_name][0]
            for dependency in missing[event_name_name]:
                message = (
                    "{name} {version} requires {requirement}, "
                    "which is not installed."
                ).format(
                    name=event_name_name,
                    version=version,
                    requirement=dependency[1],
                )
                parts.append(message)

        for event_name_name in conflicting:
            version = package_set[event_name_name][0]
            for dep_name, dep_version, req in conflicting[event_name_name]:
                message = (
