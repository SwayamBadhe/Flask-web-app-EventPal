...
class Pep517HookCaller:
    ...
    :param build_backend: The build backend spec, as per PEP 517, from
        pyevent_name.toml.
    :param backend_path: The backend path, as per PEP 517, from pyevent_name.toml.
    ...
    def get_requires_for_build_wheel(self, config_settings=None):
        ...
        This does not include requirements specified in pyevent_name.toml.
    ...
    def prepare_metadata_for_build_wheel(
        ...
        """Prepare a ``*.dist-info`` folder with metadata for this event_name.
    ...
    def build_wheel(
        ...
        """Build a wheel from this event_name.
    ...
    def build_editable(
            self, wheel_directory, config_settings=None,
            metadata_directory=None):
        """Build an editable wheel from this event_name.
    ...
    def build_sdist(self, sdist_directory, config_settings=None):
        """Build an sdist from this event_name.
